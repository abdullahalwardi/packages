...
@interface FVPVideoPlayerOptions ()
+ (FVPVideoPlayerOptions *)fromList:(NSArray<id> *)list;
+ (nullable FVPVideoPlayerOptions *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FVPVideoPlayerOptions
+ (instancetype)makeWithMixWithOthers:(nullable NSNumber *)mixWithOthers
  ...
  FVPVideoPlayerOptions* pigeonResult = [[FVPVideoPlayerOptions alloc] init];
...
+ (nullable FVPVideoPlayerOptions *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FVPVideoPlayerOptions fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 130: 
      return [FVPVideoPlayerOptions fromList:[self readValue]];
    case 131: 
...
- (void)writeValue:(id)value {
  ...
  } else if ([value isKindOfClass:[FVPVideoPlayerOptions class]]) {
    [self writeByte:130];

...
class VideoPlayerOptions {
  ...
  static VideoPlayerOptions decode(Object result) {
    result as List<Object?>;
    return VideoPlayerOptions(
      mixWithOthers: result[0] as bool?,
      allowBackgroundPlayback: result[1] as bool?,
      minBufferMs: result[2] as int?,
      maxBufferMs: result[3] as int?,
      bufferForPlaybackMs: result[4] as int?,
      bufferForPlaybackAfterRebufferMs: result[5] as int?,
    );
  }
}
...
class CreateMessage {
  ...
  static CreateMessage decode(Object result) {
    ...
    return CreateMessage(
      ...
      options: result[6] as VideoPlayerOptions?,
    );
  }
}
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    }    else if (value is VideoPlayerOptions) {
      buffer.putUint8(131);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 131: 
        return VideoPlayerOptions.decode(readValue(buffer)!);
      case 132: 
